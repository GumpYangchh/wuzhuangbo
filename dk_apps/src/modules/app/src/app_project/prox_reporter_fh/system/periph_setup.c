...
*/    
    ...
    RESERVE_GPIO( RED_LED, GPIO_BAT_LED_PORT, GPIO_BAT_LED_PIN, PID_GPIO);
	  #if (BLE_SAMPLE128)
			  RESERVE_GPIO( RED_LED, GPIO_LED3_PORT, GPIO_LED3_PIN, PID_GPIO);
	      RESERVE_GPIO( RED_LED, GPIO_LED4_PORT, GPIO_LED4_PIN, PID_GPIO);	
	  #endif //BLE_SAMPLE128
#endif
...
void set_pad_functions(void)        // set gpio port function mode
{
    ...
    GPIO_ConfigurePin( GPIO_LED3_PORT, GPIO_LED3_PIN, OUTPUT, PID_GPIO, true );
	  GPIO_ConfigurePin( GPIO_LED4_PORT, GPIO_LED4_PIN, OUTPUT, PID_GPIO, true );
